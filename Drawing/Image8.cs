...
{
	/// <summary>
	/// Describes a single-chunked image of 1, 3 (RGB) or 4 (RGBX) unsigned 8-bit integers pre pixel.
	/// </summary>
	...
	public class Image8 : ChunkedImage8
	{
		#region Constructors
		/// <summary>
		...
		public Image8(int width, int height, bool RGB, bool extraChannel, bool init, PlanarConfiguration planarConfig = PlanarConfiguration.Continuously) :
		...
		/// <param name="planarConfig">The planar configuration to use. Single-channel images must be continuously.</param>
		public Image8(int width, int height, bool RGB, bool extraChannel, byte[] initColor, PlanarConfiguration planarConfig = PlanarConfiguration.Continuously) :
		...
		/// <param name="planarConfig">The planar configuration to use. Single-channel images must be continuously.</param>
		public Image8(int width, int height, bool RGB, bool extraChannel, int initColor = 0, PlanarConfiguration planarConfig = PlanarConfiguration.Continuously) :
			base(width, height, RGB, extraChannel, initColor, height, planarConfig)
		{ }
		#endregion
	}
